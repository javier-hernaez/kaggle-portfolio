...
| 07 | [**RSNA Knee Abnormality Detection**](07_rsna_knee/) | Visión Médica & Transformers | DINOsaur V5 Final: Speedy Raptors v34 (DINOv2 + RadImageNet + Raptor + 4xCoAtNet) + Depth-TTA | Macro ROC-AUC | **`0.94200`** *(v7 en curso)* | **#652 / 4.284 (Top 15%)** | 🚀 En competición |
